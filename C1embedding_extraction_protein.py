...
def load_proteins():
    ...
    query = ("select distinct uniprot_id, protein_sequence from Forsat_Chembl_DTI_Raw_Protein_embedding where protein_sequence is not null")
...
if __name__ == '__main__':
    ...
    texts = list(df['protein_sequence'].values)
