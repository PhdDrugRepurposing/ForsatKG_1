...
table_name = "Forsat_Chembl_DTI_Raw_Drug_embedding"
join_column = 'canonical_smiles'

csv_path = r'models\\local_chemberta\\chemberta_embeddings_20250929_164426.csv'
...
df_embedding = df_embedding.rename(columns={'embedding': 'chemberta'})
